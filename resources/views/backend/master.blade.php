...
<head>
  ...
  <link rel="stylesheet" href="{{asset('backend/plugins/datatables-buttons/css/buttons.bootstrap4.min.cs')}}s">
</head>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; Ever green pen collections<a href="https://adminlte.io"></a></strong>
    
    <div class="float-right d-none d-sm-inline-block">
      <b>Design & dveloped by</b> pen collections.
    </div>
  </footer>
