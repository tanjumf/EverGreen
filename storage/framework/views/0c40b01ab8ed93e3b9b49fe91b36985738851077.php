                                ...
                                <div class='<?php echo e($menu->is_dashboard?"is-dashboard":""); ?>' title="<?php echo e($menu->is_dashboard?'This is setted as Dashboard':''); ?>">
                                    <i class='<?php echo e(($menu->is_dashboard)?"icon-is-dashboard fa fa-dashboard":$menu->icon); ?>'></i> <?php echo e($menu->name); ?> <span
                                            class='pull-right'><a class='fa fa-pencil' title='Edit'
                                                                  href='<?php echo e(route("MenusControllerGetEdit")."/".$menu->id); ?>?return_url=<?php echo e(urlencode(Request::fullUrl())); ?>'></a>&nbsp;&nbsp;<a
                                                title='Delete' class='fa fa-trash'
                                                onclick='<?php echo e(CRUDBooster::deleteConfirm(route("MenusControllerGetDelete") ."/".$menu->id)); ?>'
                                            ...
                                            <li data-id='<?php echo e($child->id); ?>' data-name='<?php echo e($child->name); ?>'>
                                                <div class='<?php echo e($child->is_dashboard?"is-dashboard":""); ?>'
                                                    ...
                                                    <span class='pull-right'><a class='fa fa-pencil' title='Edit'
                                                                                href='<?php echo e(route("MenusControllerGetEdit") ."/".$child->id); ?>?return_url=<?php echo e(urlencode(Request::fullUrl())); ?>'></a>&nbsp;&nbsp;<a
                                                                title="Delete" class='fa fa-trash'
                                                                onclick='<?php echo e(CRUDBooster::deleteConfirm(route("MenusControllerGetDelete") . "/". $child->id)); ?>'
                                                                href='javascript:void(0)'></a></span>
                                                    <br/><em class="text-muted">
                                                        <small><i class="fa fa-users"></i> &nbsp; <?php echo e(implode(', ',$privileges)); ?></small>
                                                    </em>
...
<?php echo $__env->make('crudbooster::admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DCL\Desktop\project2020\blog\vendor\crocodicstudio\crudbooster\src/views/menus_management.blade.php ENDPATH**/ ?>